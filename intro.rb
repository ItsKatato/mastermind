...
Welcome to Mastermind!
  How do you play?
    There are two players: The Codemaker and Codebreaker. The codemaker chooses a secret code with 4 numbers between 1 & 6.
    
    Example:
      #{" 4 ".bluebg} #{" 2 ".redbg} #{" 3 ".yellowbg} #{" 4 ".bluebg} 

    The Codebreaker has to figure out the secret code within 12 attempts.
    Each guess the Codebreaker will get a clue whether their guess includes a number that's correct and in the right spot
      or is correct and in the wrong spot.
